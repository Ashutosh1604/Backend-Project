...
const generateAccessAndRefreshTokens = async(userId) =>{
    try {
        ...
        user.refreshToken = refreshToken  //storing in database
...
if(!(username || email))
{
    throw new ApiError(400,"usernanme or email required!")
}
...
const logoutUser= asyncHandler(async(req,res)=>{
    ...
    await User.findByIdAndUpdate(req.user._id,
        {
           $unset:{refreshToken:1} //this removes the field from doc
        },
        {
           new: true
        }
...
const changeCurrentPassword= asyncHandler(async(req,res)=>{
 ...
 res.status(200).json(new ApiResponse(200,{},"Password chnaged successfully") )
